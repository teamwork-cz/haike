...
<section class="mb100">
  ...
  <section class="bgw mt10 p10 ">
    <mt-cell class="bgw f14 gray" title="4日租金" >
       <span class="cblack">￥300.00</span>
    </mt-cell>
    <mt-cell class="bgw f14 gray" title="押金" >
       <span class="cblack">￥300.00</span>
    </mt-cell>
    <mt-cell class="bgw f14 gray" title="优惠券" is-link >
       <span class="cblack">请选择优惠券 </span>
    </mt-cell>
    <mt-cell class="bgw f14 gray" title="总计" >
       <span class="cblack">￥300.00</span>
    </mt-cell>
 </section>
