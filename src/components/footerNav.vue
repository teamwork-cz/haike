<template>
  <footer class="footer" :class="{'go-back': !showNav}">
  	<section class="footer mint-1px-t" v-show="showNav">
	  	...
	  	<nav class="nav nav-cinama" :class="{'cur-page': route === '/order'}">
			<router-link to="order">
				<div class="nav-icon">
					<img v-show="route !== '/order'" src="../assets/images/mno.svg" alt="">
					<img v-show="route === '/order'" src="../assets/images/mok.svg" alt="">
				</div>
			</router-link>
	  	</nav>
	  	<nav class="nav nav-show" :class="{'cur-page': route === '/show'}">
	  		<router-link to="show">
	  			<div class="nav-icon">
	  				<img v-show="route !== '/show'" src="../assets/images/eno.svg" alt="">
	  				<img v-show="route === '/show'" src="../assets/images/eok.svg" alt="">
	  			</div>
	  		</router-link>
	  	</nav>
